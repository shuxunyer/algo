...
func TestMergeSortedList(t *testing.T) {
	n5 := &ListNode{value: 13}
	n4 := &ListNode{value: 11, next: n5}
	n3 := &ListNode{value: 5, next: n4}
	n2 := &ListNode{value: 3, next: n3}
	n1 := &ListNode{value: 1, next: n2}
	l1 := &LinkedList{head: &ListNode{next: n1}}

	n10 := &ListNode{value: 16}
	n9 := &ListNode{value: 15, next: n10}
	n8 := &ListNode{value: 14, next: n9}
	n7 := &ListNode{value: 2, next: n8}
	n6 := &ListNode{value: 1, next: n7}
...
func TestDeleteBottomN(t *testing.T) {
	...
	n9 := &ListNode{value: 9, next: n10}
	n8 := &ListNode{value: 8, next: n9}
	n7 := &ListNode{value: 7, next: n8}
	n6 := &ListNode{value: 6, next: n7}
	n5 := &ListNode{value: 5,next:n6}
	n4 := &ListNode{value: 4, next: n5}
	n3 := &ListNode{value: 3, next: n4}
	n2 := &ListNode{value: 2, next: n3}
	n1 := &ListNode{value: 1, next: n2}
	l1 := &LinkedList{head: &ListNode{n1,0}}
	l1.Print()
	l1.DeleteBottomN(10)
	l1.Print()
}
